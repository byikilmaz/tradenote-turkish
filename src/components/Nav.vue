            ...
            <div class="row">
                <div id="step11" class="col align-self-end">
                    <button class="btn blueBtn btn-sm" href="#" id="navbarDropdown" type="button"
                        ...
                        <i class="uil uil-plus me-2"></i>Ekle</button>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li>
                            <a class="dropdown-item" @click="navAdd('addTrades')">İşlemler</a>
                        </li>
                        <li>
                            <a class="dropdown-item" @click="navAdd('addDiary')">Günce Kaydı</a>
                        </li>
                        <li>
                            <a class="dropdown-item" @click="navAdd('addScreenshot')">Ekran Görüntüsü</a>
                        </li>
                        <li>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li>
                            <a class="dropdown-item" href="settings">
                                <i class="uil uil-sliders-v-alt me-2"></i>Ayarlar</a>
                        </li>

                        <li>
                            <a class="dropdown-item" href="imports">
                                <i class="uil uil-import me-2"></i>İçe Aktar</a>
                        </li>

                        <li>
                            <a class="dropdown-item" v-on:click="useInitShepherd()">
                                <i class="uil uil-question-circle me-2"></i>Rehber</a>
                        </li>

                        <li>
                            <a class="dropdown-item" v-on:click="logout()">
                                <i class="uil uil-signout me-2"></i>Çıkış</a>
                        </li>
                        <li>
